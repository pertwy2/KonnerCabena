...
export const about = {
  heading: "About",
  photo: "[ SECOND PHOTO — STUDIO / CANDID ]",
  body: [
...
export const reels = {
  heading: "Voice Reels",
  items: [
    { id: "r1", n: "01", title: "[REEL 01 — TITLE]", note: "[Category · what it shows]", duration: "[0:00]", seed: 1.2, src: null },
    { id: "r2", n: "02", title: "[REEL 02 — TITLE]", note: "[Category · what it shows]", duration: "[0:00]", seed: 3.7, src: null },
    { id: "r3", n: "03", title: "[REEL 03 — TITLE]", note: "[Category · what it shows]", duration: "[0:00]", seed: 6.1, src: null },
